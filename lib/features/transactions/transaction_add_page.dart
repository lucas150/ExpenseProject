...
//                       children: [
//                         Icon(
//                           _isEditing ? Icons.check_circle : Icons.check_circle,
//                           color: Colors.white,
//                           size: 32,
//                         ),
//                         const SizedBox(height: 4),
...
//     } catch (e) {
//       print(
//         'Error ${_isEditing ? 'updating' : 'saving'} transaction: $e',
//       ); // Debug info
//       if (mounted) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
...
//         ),
//         content: Text(
//           'Are you sure you want to delete "${widget.existingTransaction?.title}"? This action cannot be undone.',
...
class _AddTransactionPageState extends ConsumerState<AddTransactionPage> {
  ...
  // Account Dropdown with Quick Add
  Widget _buildAccountDropdown(
    AsyncValue<List<Account>> data,
    Color surface,
    Color t1,
  ...
  String _formatAmount(String a) {
    ...
    final formatter = RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))');
    String formatted = val.toStringAsFixed(2);
    return formatted.replaceAllMapped(formatter, (Match m) => '${m},');
  }
