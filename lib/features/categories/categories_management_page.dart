// // lib/features/categories/pages/categories_management_page.dart
...
//       body: TabBarView(
//         controller: _tabController,
//         children: [_ExpenseCategoriesTab(), _IncomeCategoriesTab()],
//       ),
...
//             onDelete: () => _deleteCategory(ref, category.name, true),
//           );
//         },
//       ),
//     );
...
//   void _deleteCategory(WidgetRef ref, String categoryName, bool isExpense) {
...
//             onDelete: () => _deleteCategory(ref, category.name, false),
//           );
//         },
//       ),
//     );
...
//     return AlertDialog(
//       title: Text(
//         'Add ${widget.isExpenseCategory ? 'Expense' : 'Income'} Category',
//       ),
...
//             .addCategory(_nameController.text, _subcategories);
//       } else {
//         await ref
