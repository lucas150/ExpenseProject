...
class BalanceOverviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Card(
      color: palette[AppColors.surface],
      elevation: 0,
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildBalanceBox('Income', total: 12000),
                _buildBalanceBox('Expenses', total: 4000),
                _buildBalanceBox('Net', total: 8000),
              ],
            ),
          ],
        ),
  ...
  Widget _buildBalanceBox(String label, {required double total}) {
    return Column(
      children: [
        Text(
          label,
