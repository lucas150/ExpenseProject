...
// // //             // Transactions list - LIMITED TO 5
// // //             Expanded(
// // //               child: Container(
...
// // //                                 Text(
// // //                                   '${filtered.length - 5} more transactions',
// // //                                   style: TextStyle(
// // //                                     fontSize: 12,
// // //                                     color: text2.withOpacity(0.6),
// // //                                   ),
...
// //             // Header - Just title and swipe hint
// //             Padding(
// //               padding: const EdgeInsets.symmetric(horizontal: 20),
// //               child: Row(
// //                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
// //                         // See More button - BELOW transactions
// //                         if (hasMoreTransactions) ...[
// //                           Container(
// //                             width: double.infinity,
// //                             padding: const EdgeInsets.symmetric(
...
// //                                       children: [
// //                                         Text(
// //                                           'See All ${filtered.length} Transactions',
// //                                           style: TextStyle(
// //                                             color: accent,
// //                                             fontSize: 14,
// //                                             fontWeight: FontWeight.w500,
...
// //                                 const SizedBox(height: 8),
// //                                 Text(
// //                                   '${filtered.length - 5} more transactions available',
// //                                   style: TextStyle(
// //                                     fontSize: 12,
// //                                     color: text2.withOpacity(0.6),
// //                                   ),
...
//                   style: TextStyle(fontSize: 12, color: text2.withOpacity(0.8)),
//                 ),
//               ],
//             ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 16), // FIXED: Adequate space
            // Amount and date - Fixed width to prevent overflow
            SizedBox(
              width: 80, // FIXED: Fixed width prevents layout issues
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                mainAxisSize:
                    MainAxisSize.min, // FIXED: Don't expand vertically
