...
//                               final transaction = recentTransactions[index];
//                               return enhancedTransactionRow(
//                                 context, // Pass context instead of ref
//                                 ref, // Pass ref as separate parameter
//                                 transaction,
//                                 text1,
//                                 text2,
//                                 green,
...
// // FIXED Enhanced Transaction Row - Using context parameter instead of ref.context
// Widget enhancedTransactionRow(
//   BuildContext context, // Added context parameter
//   WidgetRef ref, // Keep ref for other operations
//   TransactionModel transaction,
//   Color text1,
//   Color text2,
//   Color green,
...
//       try {
//         return await showDialog<bool>(
//               context: context, // Use the passed context directly
//               barrierColor: Colors.black.withOpacity(0.3),
...
//             false;
//       } catch (e) {
//         // Handle the case where the widget is deactivated
//         return false;
//       }
//     },
//     onDismissed: (direction) => onDelete?.call(),
