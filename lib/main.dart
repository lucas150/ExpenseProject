...
// //   const NoteGoApp({Key? key}) : super(key: key);
...
// // lib/main.dart - Updated with proper theme integration
...
//         title: 'Note-Go Expense Tracker',
//         routerConfig: router,
//         theme: AppTheme.lightTheme(Colors.white),
//         darkTheme: AppTheme.darkTheme(Colors.deepOrangeAccent),
...
import 'package:expense_project/core/services/database_service.dart';
import 'package:expense_project/app/app_router/app_router.dart';
import 'package:expense_project/features/settings/modern_settings_page.dart'; // Import the theme provider
...
class NoteGoApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      ...
      // CRITICAL: Connect theme to the provider
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
        useMaterial3: true,
      ...
      themeMode: isDarkMode ? ThemeMode.dark : ThemeMode.light, // CRITICAL LINE
